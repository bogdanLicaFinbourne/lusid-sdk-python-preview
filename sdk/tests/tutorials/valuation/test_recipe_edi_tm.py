...
class EdiTmRecipes(unittest.TestCase):
    ...
    def test_edi_base_recipe(self):
        ...
        valuation_request = self.create_valuation_request(
            self.portfolio_scope, self.gbp_portfolio_code, self.recipe_scope, self.recipe_code
        )
        ...
        self.assertEqual(valuation.data[0][valuation_key], 8158.0)
        self.assertEqual(valuation.data[1][valuation_key], 1840.5)
    ...
    def test_trader_made_base_recipe(self):
        ...
        valuation_request = self.create_valuation_request(
            self.portfolio_scope, self.xccy_portfolio_code, self.recipe_scope, self.recipe_code
        )
